...
def tabelaPotencias(f, sistema: sistema.Sistema, pu: bool):
...
def relatorioCircuitos(f, sistema: sistema.Sistema, pu: bool):
    dcircuitos = sistema.dcircuitos
    basePu = sistema.base
    fluxoPkm = sistema.fluxoPkm
    fluxoPmk = sistema.fluxoPmk
...
def exportarSistema(output: str, sistema: dict):
