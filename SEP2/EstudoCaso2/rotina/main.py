...
def alternado(sis):
    ...
    parametrosTensao = {
            ...
            "ALPHA_TENSAO" : 0.7,
            "OBJETIVO_TENSAO" : 1.0,
            "BARRA_OBJETIVO_TENSAO" : 4,
            "BARRAS_CONTROLE_TENSAO" : '1',
            }
    correcoes1 = []
    sis, correcoes1 = alternados.controleTensao(sis, parametrosTensao)
    # correcoes1 = []
...
# Fim Esutdo caso 2 teste

def main():
    exibir.printarCabecalho()

    sis = app.iniciarSistema()
